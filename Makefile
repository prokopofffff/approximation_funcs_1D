...
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile basic_graph.pro
#############################################################################
...
CXXFLAGS      = -std=c++20 -Wno-error=c++20-attribute-extensions -pipe -stdlib=libc++ -O3 -fstack-protector-all -g -W -Wall -Wextra -Wunused -Wcast-align -Werror -pedantic -pedantic-errors -Wfloat-equal -Wpointer-arith -Wformat-security -Wmissing-format-attribute -Wformat=2 -Wwrite-strings -Wcast-align -Wno-long-long -Woverloaded-virtual -Wnon-virtual-dtor -Wcast-qual -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=14.0 -Wall -Wextra $(DEFINES)
...
DISTDIR = /Users/jonya_ko/msu/approximation_funcs_1D/.tmp/basic_graph1.0.0
...
SOURCES       = main.cpp \
		window.cpp \
		interpolation.cpp moc_window.cpp
OBJECTS       = main.o \
		window.o \
		interpolation.o \
		moc_window.o
...
EXPORT__QMAKE_STASH_ = /Users/jonya_ko/msu/approximation_funcs_1D/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/jonya_ko/msu/approximation_funcs_1D/basic_graph.pro
...
basic_graph.app/Contents/MacOS/basic_graph:  $(OBJECTS)  
	@test -d basic_graph.app/Contents/MacOS/ || mkdir -p basic_graph.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: basic_graph.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/macx.conf \
...
basic_graph.app/Contents/Info.plist: 
	...
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.basic-graph,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.basic-graph,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,basic_graph,g" -e "s,@LIBRARY@,basic_graph,g" -e "s,\$${EXECUTABLE_NAME},basic_graph,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >basic_graph.app/Contents/Info.plist

all: Makefile \
		basic_graph.app/Contents/PkgInfo \
		basic_graph.app/Contents/Info.plist basic_graph.app/Contents/MacOS/basic_graph
...
distdir: FORCE
	...
	$(COPY_FILE) --parents window.h interpolation.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp window.cpp interpolation.cpp $(DISTDIR)/
...
moc_predefs.h: /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp
	/Library/Developer/CommandLineTools/usr/bin/clang++ -std=c++20 -Wno-error=c++20-attribute-extensions -pipe -stdlib=libc++ -O3 -fstack-protector-all -g -W -Wall -Wextra -Wunused -Wcast-align -Werror -pedantic -pedantic-errors -Wfloat-equal -Wpointer-arith -Wformat-security -Wmissing-format-attribute -Wformat=2 -Wwrite-strings -Wcast-align -Wno-long-long -Woverloaded-virtual -Wnon-virtual-dtor -Wcast-qual -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=14.0 -Wall -Wextra -dM -E -o moc_predefs.h /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp
...
moc_window.cpp: window.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/jonya_ko/msu/approximation_funcs_1D/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/jonya_ko/msu/approximation_funcs_1D -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/17/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib window.h -o moc_window.cpp
...
window.o: window.cpp /opt/homebrew/lib/QtGui.framework/Headers/QPainter \
